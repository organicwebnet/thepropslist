...
let PRICE_STARTER: string | undefined;
let PRICE_STANDARD: string | undefined;
let PRICE_PRO: string | undefined;
...
function getLocalizedEmailContent(resetUrl: string, locale: string = 'en') {
  const translations = {
    en: {
