...
exports.sendCustomPasswordResetEmailFixed = void 0;
...
exports.sendCustomPasswordResetEmailFixed = (0, https_1.onCall)({
    region: "us-central1",
    ...
    `;
        ...
        // Send email using Gmail SMTP - CORRECT METHOD NAME
