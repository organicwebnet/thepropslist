...
export default function PropDetailScreen() {
  ...
  const renderImage = () => {
    ...
    if (isValidImageSource(imageSource)) {
        console.log('!!!!!!!!!! ATTEMPTING TO RENDER IMAGE (PropDetailScreen) !!!!!!!!!!!');
        console.log('PropDetailScreen - imageSource VALUE:', JSON.stringify(imageSource));
        console.log('PropDetailScreen - imageSource TYPE:', typeof imageSource);
        if (imageSource && typeof imageSource === 'object' && 'uri' in imageSource) {
          console.log('PropDetailScreen - imageSource.uri TYPE:', typeof imageSource.uri);
        }
        return (
          <Image
            source={imageSource} 
